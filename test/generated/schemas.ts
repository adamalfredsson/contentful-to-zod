...
export const bentoRow1Schema = z.object({
    ...
    fields: z.object({
    column1: z.union([marketingBannerCardSchema, imageCardSchema, formCardSchema, contentCardSchema, contentWithImageCardSchema]),
...
export const bentoRow2Schema = z.object({
    ...
    column2: z.union([contentCardSchema, imageCardSchema, contentWithImageCardSchema])
  })
  });
...
export const bentoRow4Schema = z.object({
    ...
    fields: z.object({
    column1: z.union([imageCardSchema, consultationCardSchema, clientsCardSchema])
  })
  });
...
export const pageSchema = z.object({
    ...
    hero: heroSchema,
    content: z.array(z.union([bentoRow1Schema, bentoRow2Schema, bentoRow3Schema, bentoRow4Schema])),
    seo: z.object({
    sys: z.object({
    contentType: z.object({
    sys: z.object({
